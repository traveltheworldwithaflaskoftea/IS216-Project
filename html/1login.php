          ...
          <div class="row d-flex justify-content-center">
              ...
              <form action='process_login.php' method='POST' class='p-2'>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="ml-2 form-control" id="username" placeholder="Username" name='username' required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="ml-2 form-control" id="password" placeholder="Password" name='password' required>
                  </div>
                </div>
